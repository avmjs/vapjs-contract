    ...
    it('should construct properly', (done) => {
      ...
      vap.accounts((accountsError, accounts) => {
        ...
        SimpleStore.new((newError, newResult) => {
          ...
          setTimeout(() => {
            vap.getTransactionReceipt(newResult, (errorReceipt, receipt) => {
              ...
              simpleStore.set(setNumberValue, (setError, setResult) => {
                ...
                setTimeout(() => {
                  vap.getTransactionReceipt(newResult, (setTxReceiptError, setTxReceipt) => {
    ...
    it('should construct properly constructor params', (done) => {
      ...
      vap.accounts((accountsError, accounts) => {
        ...
        SimpleStore.new(initalValue, initalAddreeArray, (newError, newResult) => {
          ...
          setTimeout(() => vap.getTransactionReceipt(newResult, (setTxReceiptError, setTxReceipt) => {
            ...
            */
            ...
            const args = [453,
              ...
              (multiSetTypeError, multiSetTypeResult) => {
                setTimeout(() => vap.getTransactionReceipt(multiSetTypeResult, (multiSetReceiptError, multiSetReceipt) => {
